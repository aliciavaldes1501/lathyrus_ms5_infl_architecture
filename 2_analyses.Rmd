...
```{r}
mod_seedpred_87<-glmmTMB(cbind(n_pred_seeds,n_seeds-n_pred_seeds)~
                           relpos_fl*relpos_rac+
                          (1|id/shoot_id/raceme_id),
                        subset(data_id_flowers,year==1987),family="binomial")
mod_seedpred_88<-glmmTMB(cbind(n_pred_seeds,n_seeds-n_pred_seeds)~
                           relpos_fl*relpos_rac+
                          (1|id/shoot_id/raceme_id),
                        subset(data_id_flowers,year==1988),family="binomial")
mod_seedpred_89<-glmmTMB(cbind(round(n_pred_seeds),n_seeds-round(n_pred_seeds))~
                           relpos_fl*relpos_rac+
                          (1|id/shoot_id/raceme_id),
                        subset(data_id_flowers,year==1989),family="binomial")
...
Significant effect of relpos_fl in all years

```{r}
plot(ggpredict(mod_seedpred_87,terms="relpos_fl[all]"))
plot(ggpredict(mod_seedpred_87,terms="relpos_fl[all]"))
plot(ggpredict(mod_seedpred_87,terms="relpos_fl[all]"))
```

Basal flowers (lower relpos_fl) have a higher seed predation than distal flowers within the raceme.
...
fig6<-grid.arrange(
  grid.arrange(
    ...
    ggtitle("Proportion of predated seeds 1987"),
    plot(ggpredict(mod_seedpred_89,terms="relpos_fl[all]"))+
    ggtitle("1988"),
    plot(ggpredict(mod_seedpred_89,terms="relpos_fl[all]"))+
    ggtitle("1989"),
...
### Variance of opening date

```{r}
mod_frset_87_Q4c<-glmmTMB(fruit_set~(relpos_fl*relpos_rac)* 
                           # Interaction * in mod_frset_87 
                           var_opening_date+
                         (1|id/shoot_id/raceme_id),
                         subset(data_id_flowers,year==1987),family="binomial")
mod_frset_88_Q4c<-glmmTMB(fruit_set~(relpos_fl+relpos_rac)* 
                           # Interaction NS in mod_frset_88 
                           var_opening_date+
                         (1|id/shoot_id/raceme_id),
                         subset(data_id_flowers,year==1988),family="binomial")
mod_frset_89_Q4c<-glmmTMB(fruit_set~(relpos_fl+relpos_rac)* 
                           # Interaction NS in mod_frset_89 
                           var_opening_date+
                         (1|id/shoot_id/raceme_id),
                         subset(data_id_flowers,year==1989),family="binomial")
summary(mod_frset_87_Q4c)
summary(mod_frset_88_Q4c)
summary(mod_frset_89_Q4c)
Anova(mod_frset_87_Q4c)
Anova(mod_frset_88_Q4c)
Anova(mod_frset_89_Q4c)
```


## Fruit initiation & flowering duration

### USE: Fruit initiation & range
...
```{r}
tab_model(mod_frset_87_Q4ab,mod_frset_88_Q4ab,mod_frset_89_Q4ab,
          transform=NULL,show.intercept=F,show.ci=F,show.se=T,show.stat=T,
          show.r2=T,show.icc=F,show.re.var=F,show.ngroups=F,digits=3,
          dv.labels=c("1987","1988","1989"),
...
### Fruit initiation & variance

```{r}
mod_frset_87_Q4ac<-glmmTMB(fruit_set~(relpos_fl*relpos_rac)* 
                           # Interaction * in mod_frset_87 
                           (tot_fr_init_in_plant+var_opening_date)+
                         (1|id/shoot_id/raceme_id),
                         subset(data_id_flowers,year==1987),family="binomial")
mod_frset_88_Q4ac<-glmmTMB(fruit_set~(relpos_fl+relpos_rac)* 
                           # Interaction NS in mod_frset_88 
                           (tot_fr_init_in_plant+var_opening_date)+
                         (1|id/shoot_id/raceme_id),
                         subset(data_id_flowers,year==1988),family="binomial")
mod_frset_89_Q4ac<-glmmTMB(fruit_set~(relpos_fl+relpos_rac)* 
                           # Interaction NS in mod_frset_89 
                           (tot_fr_init_in_plant+var_opening_date)+
                         (1|id/shoot_id/raceme_id),
                         subset(data_id_flowers,year==1989),family="binomial")
summary(mod_frset_87_Q4ac)
summary(mod_frset_88_Q4ac)
summary(mod_frset_89_Q4ac)
Anova(mod_frset_87_Q4ac)
Anova(mod_frset_88_Q4ac)
Anova(mod_frset_89_Q4ac)
```

## Figure 8

```{r}
fig8a<-plot(ggpredict(mod_frset_87_Q4ab,
                      terms=c("relpos_fl[all]","range_opening_date[quart]",
                              "relpos_rac")))+
  ggtitle("1987")
  # This seems to be against our prediction!
fig8b<-grid.arrange(
  ...
  ncol=2)
fig8c<-plot(ggpredict(mod_frset_89_Q4ab,
                      terms=c("relpos_rac[all]","range_opening_date[quart]")))+
  ggtitle("1989")
# According to prediction: smaller range = stronger effect
fig8<-grid.arrange(fig8a,fig8b,fig8c,ncol=1)
plot(fig8)
ggsave(filename="output/figures/fig8.tiff",plot=fig8,
